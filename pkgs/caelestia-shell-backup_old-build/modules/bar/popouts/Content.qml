...
Item {
    ...
    Item {
        ...
        Popout {
            name: "activewindow"
            sourceComponent: ActiveWindow { wrapper: root.wrapper }
        }
        ...
        Popout {
            name: "bluetooth"
            sourceComponent: Bluetooth { wrapper: root.wrapper }
        }

        Popout {
            name: "audio"
            sourceComponent: Audio { wrapper: root.wrapper }
        }
    ...
    component Popout: Loader {
        ...
        transitions: [
            Transition {
                ...
                to: ""
                SequentialAnimation {
                    Anim { properties: "opacity,scale"; duration: Appearance.anim.durations.small }
