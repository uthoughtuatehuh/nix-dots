{ config, pkgs, ... }:
{
  xdg.configFile."hypr/modules/keybinds.conf".text = ''
    ...
    # Window Management
    bind = $mainMod SHIFT, D, fullscreen, 1 # Maximize
    ...
    # Wallpapers
    bind = Ctrl+Alt, T, exec, bash ~/.config/hypr/scripts/switch_wallpaper.sh set
  '';
}
