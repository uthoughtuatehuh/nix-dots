{ config, pkgs, ... }:
{
  xdg.configFile."waybar/icons/jetbrains-idea.svg".text = ''
    <svg version="1.1" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
     ...
     <path d="m15 14v2h2v7h-2v2h6v-2h-2v-7h2v-2h-6zm13 0v6.96c0 0.662-7.05e-4 1.22-0.482 1.62-0.482 0.409-1.28 0.477-1.91 0.395-0.624-0.0829-1.22-0.578-1.62-0.992l-1.21 1.37c0.761 0.695 1.61 1.48 2.82 1.62l0.611 0.0137c0.955-0.132 1.98-0.215 2.77-1.02 0.494-0.53 1.03-1.48 1.02-2.89l0.00586-7.08h-2zm-15 18v2h10v-2h-10z" style="fill:#f9f9f9"/>
    </svg>
  '';
}
